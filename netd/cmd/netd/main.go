...
func main() {
	...
	p := proxy.NewProxy(
		...
		cfg.FailClosed,
		cfg.ProxyMaxIdleConns,
		cfg.ProxyMaxIdleConnsPerHost,
		cfg.ProxyIdleConnTimeout.Duration,
		cfg.ProxyResponseHeaderTimeout.Duration,
		cfg.AuditLogPath,
		cfg.AuditLogMaxBytes,
		cfg.AuditLogMaxBackups,
	)
